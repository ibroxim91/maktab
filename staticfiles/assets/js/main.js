/************************************
	Add preload to DOM
*************************************/
$('body').prepend('<div id="loader"><img class="loader-img" src="/static/assets/svg/courses.svg" alt="loader icon" /></div>') 
	...
	$(document).ready(function() {
		...
		*************************************/
		$('#search').on('click', function(event) {
			$('body').prepend('<div id="search-box" class="fadeIn"><a href="#" id="close-searchbox"><i class="fas fa-times"></i></a> <form action="" method="GET"> <div class="input-group"> <input type="text" name="q" placeholder="Izlayotgan narsangizni yozing..."> <button><i class="fas fa-arrow-right"></i></button> </div></form> </div>')
